...
export TARGET_CONFIGURE_FLAGS="--with-cpu=powerpc64 --with-abi=elfv2 --enable-secureplt --disable-altivec --with-long-double-64"

# Work directories
export CWORK="$HOME/sysroot/${TARGET}-elfv2"
